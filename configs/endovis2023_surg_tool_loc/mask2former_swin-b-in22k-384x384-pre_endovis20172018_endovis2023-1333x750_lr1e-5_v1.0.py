...
load_from = "/data2/src/atsushi/mmsegmentation/work_dirs/mask2former_swin-b-in22k-384x384-pre_sarrarp50_endovis20172018-1333x750_lr1e-5/epoch_30.pth"  # noqa
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            ...
            dict(
                type=dataset_type,
                data_root=data_root + "/EndoVis2023/SurgToolLoc/v1.0",
                data_prefix=dict(img_path="frame", seg_map_path="semantic_mask"),
                dump_path="train_files_2023_v1.0.csv",
                pipeline=train_pipeline,
            ),
        ],
    ),

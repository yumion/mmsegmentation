...
load_from = "/data2/src/atsushi/SurgToolLoc/work_dirs/mask2former_swin-b-in22k-384x384-pre_endovis20172018_endovis2023-1333x750_lr1e-5_v1.0/epoch_30.pth"  # noqa
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root + "/EndoVis2023/SurgToolLoc/v1.2",
        data_prefix=dict(img_path="frame", seg_map_path="semantic_mask"),
        dump_path="train_files_2023_v1.2.csv",
...
auto_scale_lr = dict(enable=False, base_batch_size=batch_size * num_gpus)
...
# optimizer
optimizer = dict(type="AdamW", lr=lr, weight_decay=0.005, eps=1e-8, betas=(0.9, 0.999))
optim_wrapper = dict(
    type="OptimWrapper",
    optimizer=optimizer,
